...
<script>
	window.onload = function(){
		...
		const fileDels = document.getElementsByCalssName('fileDel');
				...
				if(confirm('정말 삭제 하시겠습니까?')){
					...
					.then((data)=>{
						...
						if(count == 0){
							...
							fileInput.setAtttribute('type', 'file');
							fileInput.setAtttribute('name', 'fname');
							fileInput.setAtttribute('multiple', 'multiple');
...
<main id="board">
    <section class="modify">
        ...
        <form action="/jboaed2/modify.do" method="post" enctype="multipart/form-data">
